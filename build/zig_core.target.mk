...
TARGET := zig_core
DEFS_Debug := \
	'-DNODE_GYP_MODULE_NAME=zig_core' \
	'-DUSING_UV_SHARED=1' \
	'-DUSING_V8_SHARED=1' \
...
$(builddir)/zig_core.node: GYP_LIBTOOLFLAGS := $(LIBTOOLFLAGS_$(BUILDTYPE))
$(builddir)/zig_core.node: TOOLSET := $(TOOLSET)
$(builddir)/zig_core.node: $(OBJS) FORCE_DO_CMD
	$(call do_cmd,solink_module)

all_deps += $(builddir)/zig_core.node
# Add target alias
.PHONY: zig_core
zig_core: $(builddir)/zig_core.node

# Short alias for building this executable.
.PHONY: zig_core.node
zig_core.node: $(builddir)/zig_core.node

# Add executable to "all" target.
.PHONY: all
all: $(builddir)/zig_core.node
