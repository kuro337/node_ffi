...
extern const char *parseFileGetSnippet(const char *file_path, bool new_snippet_file, bool print_out);
...
extern int *parseFileWriteOutput(const char *input_file, const char *output_file, const char *title, const char *prefix, const char *description, bool create, bool force, bool print);

extern const char *parseStringWriteToFile(const char *str, const char *output_file, const char *title, const char *prefix, const char *description, bool create, bool force, bool print);
...
napi_value ZigParseFileGetSnippet(napi_env env, napi_callback_info args)
{
  ...
  // Call the Zig function
  const char *result_from_zig = parseFileGetSnippet(file_path, new_snippet_file, print_out);
...
napi_value ZigParseFileWriteOutput(napi_env env, napi_callback_info info)
{
  ...
  // Call the Zig function
  int result = parseFileWriteOutput(input_file, output_file, title, prefix, description, create, force, print);
...
napi_value ZigParseStringWriteToFile(napi_env env, napi_callback_info info)
{
  ...
  const char *result_from_zig = parseStringWriteToFile(lines, output_file, title, prefix, description, create, force, print);
