...
napi_value Init(napi_env env, napi_value exports)
{
  ...
  status = register_napi_function(env, exports, "parseStringFromJS", ZigParseStringFromJS);
  if (status != napi_ok)
  {
    napi_throw_error(env, NULL, "Unable to register function for parseStringFromJS");
  }
...
// OLD BELOW - using helper to avoid repetition above
...
//   // Register the 'ZigCreateSnippetWithMetadata' function
//   status = napi_create_function(env, NULL, 0, ZigConvertDirToSnippet, NULL, &fn);
//   if (status != napi_ok)
//   {
//     napi_throw_error(env, NULL, "Unable to wrap native function for convertDirToSnippet");
//     return NULL;
//   }
//   status = napi_set_named_property(env, exports, "convertDirToSnippet", fn);
//   if (status != napi_ok)
//   {
//     napi_throw_error(env, NULL, "Unable to populate exports for convertDirToSnippet");
//     return NULL;
//   }
